...
echo "[Stage1] start GPU=${GPU} bs=${STAGE1_BATCH_SIZE} lr=${STAGE1_LR} epochs=${STAGE1_EPOCHS} max_steps=${STAGE1_MAX_STEPS} early_stop=${STAGE1_ENABLE_EARLY_STOP} patience=${STAGE1_EARLY_STOP_PATIENCE} gtm_max_len=${STAGE1_GTM_MAX_LEN} gtm_text_source=${STAGE1_GTM_TEXT_SOURCE}"
"${CMD[@]}"
