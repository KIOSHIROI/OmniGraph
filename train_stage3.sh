...
map_var PSEUDO_GRAPH_QA_MAX_PER_IMAGE S3_PSEUDO_GRAPH_QA_MAX_PER_IMAGE
map_var PSEUDO_GRAPH_QA_REPEAT S3_PSEUDO_GRAPH_QA_REPEAT
map_var GRAPH_AUX_LOSS_WEIGHT S3_GRAPH_AUX_LOSS_WEIGHT
map_var XTC_WEIGHT S3_XTC_WEIGHT
map_var XTM_WEIGHT S3_XTM_WEIGHT
map_var ENABLE_XGV S3_ENABLE_XGV
map_var XGV_WEIGHT S3_XGV_WEIGHT

export PIPELINE_MODE=multimodal_tune
