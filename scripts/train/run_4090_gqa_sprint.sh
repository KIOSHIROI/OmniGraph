...
: "${S2A_CHECKPOINT_EVERY_N_STEPS:=0}"
...
: "${S2B_CHECKPOINT_EVERY_N_STEPS:=0}"
...
: "${S2B_R2_CHECKPOINT_EVERY_N_STEPS:=0}"
...
: "${S3_R2_CHECKPOINT_EVERY_N_STEPS:=0}"
...
: "${S2B_CHECKPOINT_SAVE_WEIGHTS_ONLY:=1}"
: "${S2B_CHECKPOINT_SAVE_LAST:=0}"
: "${S3_CHECKPOINT_SAVE_WEIGHTS_ONLY:=1}"
: "${S3_CHECKPOINT_SAVE_LAST:=0}"
: "${S2B_R2_CHECKPOINT_SAVE_WEIGHTS_ONLY:=1}"
: "${S2B_R2_CHECKPOINT_SAVE_LAST:=0}"
: "${S3_R2_CHECKPOINT_SAVE_WEIGHTS_ONLY:=1}"
: "${S3_R2_CHECKPOINT_SAVE_LAST:=0}"
...
if [ -n "$CHECKPOINT_ROOT" ]; then
  STAGE2A_DIR="$CHECKPOINT_ROOT/graph_bootstrap"
  STAGE2B_DIR="$CHECKPOINT_ROOT/graph_refine"
  STAGE3_DIR="$CHECKPOINT_ROOT/multimodal_tune"
  STAGE2B_R2_DIR="$CHECKPOINT_ROOT/graph_refine_round2"
  STAGE3_R2_DIR="$CHECKPOINT_ROOT/multimodal_tune_round2"
fi
...
echo "[Config] ckpt_policy: S2B(weights_only=${S2B_CHECKPOINT_SAVE_WEIGHTS_ONLY},save_last=${S2B_CHECKPOINT_SAVE_LAST}) S3(weights_only=${S3_CHECKPOINT_SAVE_WEIGHTS_ONLY},save_last=${S3_CHECKPOINT_SAVE_LAST}) S2B_R2(weights_only=${S2B_R2_CHECKPOINT_SAVE_WEIGHTS_ONLY},save_last=${S2B_R2_CHECKPOINT_SAVE_LAST}) S3_R2(weights_only=${S3_R2_CHECKPOINT_SAVE_WEIGHTS_ONLY},save_last=${S3_R2_CHECKPOINT_SAVE_LAST})"
...
if [ "$RUN_STAGE2B" = "1" ]; then
  ...
  S2B_CMD=("$PYTHON_BIN" "$REPO/omnigraph/train/train_graph_refine.py" \
    ...
    --checkpoint_save_weights_only "$S2B_CHECKPOINT_SAVE_WEIGHTS_ONLY" \
    --checkpoint_save_last "$S2B_CHECKPOINT_SAVE_LAST" \
...
if [ "$RUN_STAGE3" = "1" ]; then
  ...
  S3_CMD=("$PYTHON_BIN" "$REPO/omnigraph/train/train_multimodal_tune.py" \
    ...
    --checkpoint_save_weights_only "$S3_CHECKPOINT_SAVE_WEIGHTS_ONLY" \
    --checkpoint_save_last "$S3_CHECKPOINT_SAVE_LAST" \
...
S2B_R2_CMD=("$PYTHON_BIN" "$REPO/omnigraph/train/train_graph_refine.py" \
  ...
  --checkpoint_save_weights_only "$S2B_R2_CHECKPOINT_SAVE_WEIGHTS_ONLY" \
  --checkpoint_save_last "$S2B_R2_CHECKPOINT_SAVE_LAST" \
...
S3_R2_CMD=("$PYTHON_BIN" "$REPO/omnigraph/train/train_multimodal_tune.py" \
  ...
  --checkpoint_save_weights_only "$S3_R2_CHECKPOINT_SAVE_WEIGHTS_ONLY" \
  --checkpoint_save_last "$S3_R2_CHECKPOINT_SAVE_LAST" \
